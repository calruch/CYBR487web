...
class ParseClass:
    ...
    def buildParser(self):
        ...
        parser.add_argument('-vv', '--moreverbose',
                            help='Show more verbose output', action="store_true")
        parser.add_argument(
            '-h', '--help', help='Show usage of the program', action="store_true")
        parser.add_argument(
            '--hostid', help='Choose the host identifier type[ARP, ICMP]', default="ARP")
        parser.add_argument(
    ...
    def parser(self, args):
        ...
        # Verbose parsing - Stores a true value into parsed Args dictionary
        VerboseOption = args['verbose']
        MoreVerboseOption = args['moreverbose']
